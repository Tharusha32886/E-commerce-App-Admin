...
import 'package:yt_ecommerce_admin_panel/features/media/repositories/media_repository.dart';
import 'package:yt_ecommerce_admin_panel/features/media/screens_media/widgets/media_content.dart';
import 'package:yt_ecommerce_admin_panel/features/media/screens_media/widgets/media_uploader.dart';
...
extension MediaControllerUploadExtension on MediaController {
  // Methgana
            ...
            child: AlertDialog(
                ...
                content: Column(
                  ...
                  children: [
                    ...
                    const Text('Please wait while we upload your images.'),
                  ],
                ))));
  }
  ...
  void removeCloudImage(ImageModel image) async {
    try {
      ...
      TLoaders.successSnackBar(
          title: 'Image Deleted', message: 'Image deleted successfully.');
    } catch (e) {
      TFullScreenLoader.stopLoading();
